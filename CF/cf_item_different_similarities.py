...
class item_cf_different_similarities(Recommender):
    ...
    def fit(self, training_set, k1=100, shrink1=100, similarity1='cosine',
            k2=100, shrink2=100, similarity2='cosine', normalize=True):
        self.__urm_training = training_set
        self.__learner1 = cf_recommender_item()
        self.__learner2 = cf_recommender_item()

...
from hybrid_recommenders.item_knn_cf_cbf_different_similarity import item_knn_cf_cbf_different_similarity
import numpy as np


class graph_based_item_item_knn_cf_cbf(Recommender):
    def __init__(self, weight1, weight2, ensemble_weight, first_similarity, second_similarity):
